...
GAP_ROWS = [
    ...
    (4, "SMS Consent Auto-Stamp",
     ...
     "Contact_SMS_Opt_In_Date_Stamp before-save flow is ACTIVE — stamps SMS_Opt_In_Date__c = TODAY() on first consent, idempotent via null-guard",
     "✅ CLOSED — retrieved and confirmed active in full metadata pull (June 2026)",
     "No action needed. Verify a sample opted-in Contact has a populated Opt_In_Date__c",
     "Done", "Live"),
    (5, "OrgWide Email — no-reply@upgrademybackyard.com",
     ...
     "Run: SELECT DisplayName, Address FROM OrgWideEmailAddress — add no-reply@upgrademybackyard.com if missing",
     "Critical", "Gap"),
